<template>
    <div class="mt-16">
      ...
      <div style="font-size: 20px;text-align: center;">
        Learn how to install softwares, packages and frameworks.<br />
        Create your dream project today!<br/>

          <v-btn class="mt-10 blue white--text" @click="$emit('open')">START</v-btn>
      </div>
